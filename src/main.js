...
// 判断当前开发开发环境
function env() {
  if (process.env.NODE_ENV === 'development') return 'development' // 开发
  if (window.location.href.includes('192.168')) return 'test' // 测试
  return 'production' // 生产
}
